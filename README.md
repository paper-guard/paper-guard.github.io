# 🛡️ PaperGuard: Does AI Reviewer See the Full Picture? Attacking and Defending Multimodal Peer Review

This is the repository that contains source code for the [PaperGuard website](https://paper-guard.github.io/).
